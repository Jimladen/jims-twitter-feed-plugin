...
class ezTweet
{
    ...
    // private $options = get_option('jtp_settings');
    ...
    // private $consumer_key = 'PqDKE0xiCJNAnLE3s96xmOmYH';
    ...
    public function fetch() {
        echo json_encode(array('response' => json_decode($this->getJSON(), true), 'message' => ($this->debug) ? $this->message : false));
    }
    ...
    public function showOptions($options) {
    	// return  'test';
    	 foreach ($options as $key => $value) {
       		switch ($key) {
       			case  'jtp_text_field_0' :
       			$this->consumer_key = $value;
       			break;
       			case  'jtp_text_field_1' :
       			$this->consumer_secret = $value;
       			break;
       			case  'jtp_text_field_2' :
       			$this->user_token = $value;
       			break;
       			case  'jtp_text_field_3' :
